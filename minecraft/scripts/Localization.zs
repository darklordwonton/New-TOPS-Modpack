...
game.setLocalization("en_US","item.quadrum:plutonium_mix.name","Plutonium Powder");
game.setLocalization("en_US","item.quadrum:uranium238.name","Small Pile of Uranium 238");
game.setLocalization("en_US","item.quadrum:uranium235.name","Small Pile of Uranium 235");
game.setLocalization("en_US","item.quadrum:plutonium_weapon_small.name","Small Pile of Weapons-Grade Plutonium 239");
game.setLocalization("en_US","item.quadrum:plutonium_weapon","Pile of Weapons-Grade Plutonium");
game.setLocalization("en_US","item.quadrum:plutonium_reactor.name","Small Pile of Reactor-Grade Plutonium 239");
