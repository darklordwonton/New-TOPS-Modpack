...
var deathOrb = <elementsofpower:magicOrb:7>;
	...
	//Basic Wand
	recipes.removeShaped(<elementsofpower:magicWand>);
	recipes.addShaped(<elementsofpower:magicWand>, [[null, <ore:ingotMithril>, <smedry:lens>],[null,<godweapons:obsidian_stick>,<ore:ingotMithril>],[<ore:ingotMithril>,null,null]]);
  	...
  	//Magic Missile
  	recipes.removeShaped(<wonderfulwands:wand_missiles>);
	...
	//Fire
	recipes.removeShaped(<wonderfulwands:wand_fire>);
  ...
  return inputs.wand.withDamage(max(0, inputs.wand.damage - 4));
	...
	//Growth
	recipes.removeShaped(<wonderfulwands:wand_growth>);
  ...
  return inputs.wand.withDamage(max(0, inputs.wand.damage - 32));
	...
	//Harvesting
	recipes.removeShaped(<wonderfulwands:wand_harvesting>);
  ...
  return inputs.wand.withDamage(max(0, inputs.wand.damage - 4));
	...
	//Freezing
	recipes.removeShaped(<wonderfulwands:wand_ice>);
  ...
  return inputs.wand.withDamage(max(0, inputs.wand.damage - 128));
	...
	//Mining
	recipes.removeShaped(<wonderfulwands:wand_mining>);
  ...
  return inputs.wand.withDamage(max(0, inputs.wand.damage - 4));
	...
	//Light
	recipes.removeShaped(<wonderfulwands:wand_light>);
  ...
  return inputs.wand.withDamage(max(0, inputs.wand.damage - 128));
	...
	//Greater Light
	recipes.removeShaped(<wonderfulwands:wand_greater_light>);
  ...
  return inputs.wand.withDamage(max(0, inputs.wand.damage - 16));
	...
	//Storms
	recipes.removeShaped(<wonderfulwands:wand_storm>);
  ...
  return inputs.wand.withDamage(max(0, inputs.wand.damage - 16));
	...
	//Lightning
	recipes.removeShaped(<wonderfulwands:wand_lightning>);
  ...
  return inputs.wand.withDamage(max(0, inputs.wand.damage - 4));
	...
	//Climbing
	recipes.removeShaped(<wonderfulwands:wand_climb>);
  ...
  return inputs.wand.withDamage(max(0, inputs.wand.damage - 16));
	...
	//Illusions
	recipes.removeShaped(<wonderfulwands:wand_illusion>);
  ...
  return inputs.wand.withDamage(max(0, inputs.wand.damage - 32));
	...
	//Railroads
	recipes.removeShaped(<wonderfulwands:wand_rails>);
  ...
  return inputs.wand.withDamage(max(0, inputs.wand.damage - 64));
	...
	//Webbing
	recipes.removeShaped(<wonderfulwands:wand_webbing>);
  ...
  return inputs.wand.withDamage(max(0, inputs.wand.damage - 16));
	...
	//Levitation
		recipes.removeShaped(<wonderfulwands:wand_levitation>);
