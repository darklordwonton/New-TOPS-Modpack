...
recipes.remove(<basemetals:tin_block>);
recipes.remove(<basemetals:lead_block>);
recipes.remove(<basemetals:silver_block>);
recipes.remove(<basemetals:zinc_block>);
recipes.remove(<basemetals:platinum_block>);
recipes.remove(<basemetals:nickel_block>);
recipes.remove(<basemetals:adamantine_block>);
recipes.remove(<basemetals:coldiron_block>);
recipes.remove(<basemetals:bronze_block>);
recipes.remove(<basemetals:cupronickel_block>);
recipes.remove(<basemetals:electrum_block>);
recipes.remove(<basemetals:steel_block>);
recipes.remove(<basemetals:invar_block>);
recipes.remove(<basemetals:starsteel_block>);
recipes.remove(<basemetals:mithril_block>);
recipes.remove(<basemetals:aquarium_block>);
recipes.remove(<basemetals:brass_block>);
recipes.remove(<modernmetals:aluminumbrass_block>);
recipes.remove(<modernmetals:cadmium_block>);
recipes.remove(<modernmetals:galvanizedsteel_block>);
recipes.remove(<modernmetals:iridium_block>);
recipes.remove(<modernmetals:magnesium_block>);
recipes.remove(<modernmetals:manganese_block>);
recipes.remove(<modernmetals:nichrome_block>);
recipes.remove(<modernmetals:osmium_block>);
recipes.remove(<modernmetals:plutonium_block>);
recipes.remove(<modernmetals:rutile_block>);
recipes.remove(<modernmetals:stainlesssteel_block>);
recipes.remove(<modernmetals:tantalum_block>);
recipes.remove(<modernmetals:titanium_block>);
recipes.remove(<modernmetals:tungsten_block>);
recipes.remove(<modernmetals:uranium_block>);
recipes.remove(<modernmetals:zirconium_block>);
recipes.remove(<base:ore_copper>);
recipes.remove(<base:ore_tin>);
recipes.remove(<base:ore_silver>);
recipes.remove(<base:ore_lead>);
recipes.remove(<base:plate:*>);
...
furnace.remove(<base:ingot:18>, <basemetals:mithril_blend>);
